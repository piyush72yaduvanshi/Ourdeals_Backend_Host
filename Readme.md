...
**Complete Docker setup with MongoDB, Redis, and Backend - Ready to use!**
...
```bash
# Start all services including database management UIs
...
MONGO_ROOT_PASSWORD=Piyush73
MONGO_DATABASE=ourdeals_healthcare
...
docker exec -it mongodb_container mongosh -u admin -p Piyush73

# Access Redis CLI
docker exec -it redis_container redis-cli

# Access app container shell
docker exec -it healthcare_app sh
```
...
docker-compose down
docker volume rm ourdeals_healthcare_mongo_data
docker-compose up -d
```
